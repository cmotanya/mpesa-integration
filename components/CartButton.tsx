  ...
  return (
    <Fade duration={150} direction="right" cascade triggerOnce>
      <button
        ...
        className={cn(
          "bg-primary relative z-50 flex items-center justify-center rounded-full p-2 shadow-lg backdrop-blur-lg transition-all duration-200 ease-in-out hover:scale-105 active:scale-95",
